...
class SheetRoundRobbinService{
    ...
    private function boxPlayers($players){
        ...
        foreach($game as $g){
            ...
            $this->pdf->RoundedRect($x+$this->boxW, $y+($h/2), $gap, $h, $r, '0000', 'DF', $this->styleBoxLine, array(254,206,50));
            $x1=$x+$this->boxW+$gap;
            $y1=$y+($this->boxH/2);
            $x2=$x1+$lineW;
            $y2=$y1;
            $this->pdf->line($x1, $y1, $x2, $y2, $this->styleBoxLine);
