<template>
  <table class="tblTournament" :class="showTableGridLine ? 'gridLine' : ''">
    ...
    <tr>
      ...
      <!-- <td>a</td> -->
      <td class="topRight alignRightBottom">
        <span class="circle">{{ bouts[boutSize - 3].circle }}</span>
      </td>
      <td></td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <!-- <td>a</td> -->
      <td class="topRight alignRightBottom">
        <span class="circle">{{ bouts[boutSize - 2].circle }}</span>
      </td>
      <td></td>
    </tr>
    <tr>
...
export default {
  ...
  data() {
    return {
      ...
      boutSize: this.bouts.length,
    };
  },
  mounted() {
    console.log(this.boutSize);
  },
};
</script>
