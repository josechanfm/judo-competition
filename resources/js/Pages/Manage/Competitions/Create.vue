          ...
          >
            <div class="flex flex-col">
                ...
                <div class="" v-if="create_competition.game_type_id != null">
                  ...
                  >
                    <a-form-item label="男性組別" name="categories_male">
                      <div
                        class=""
                        v-for="category in gameTypes.find(
                          (x) => x.id == create_competition.game_type_id
                        ).categories"
                        :key="category.id"
                      >
                        <div class="">
              ...
              <div class="" v-if="setting_index == 2">
                ...
                <div>
                  <a-form-item label="5人以下" name="small_system">
              ...
              <div class="" v-if="setting_index == 3">
                <div class="">
                  <a-form-item label="開啓第二語言" name="is_language_secondary_enabled">
                    <a-switch
                      v-model:checked="create_competition.is_language_secondary_enabled"
                      :unCheckedValue="0"
                      :checkedValue="1"
                    />
                  </a-form-item>
                ...
                <div class="flex justify-between gap-3">
                  <div class="w-full flex flex-col">
                    ...
                    <div
                      class=""
                      v-if="create_competition?.is_language_secondary_enabled == 1"
                    >
                      <a-form-item
                  ...
                  <div class="w-full flex flex-col">
                    <div class="">
                      <a-form-item label="Competition Language" name="language">
                        <a-select
                          v-model:value="create_competition.language"
                    ...
                    >
                      ...
                      >
                        <a-select
                          v-model:value="create_competition.language_secondary"
                          :options="selectLanguage"
                          :fieldNames="{ value: 'value', label: 'name' }"
                        ></a-select>
                      </a-form-item>
  ...
  methods: {
    ...
    onUpdate() {
      this.$refs.formRef
        ...
        .then(() => {
          this.$inertia.put(
            route("manage.competitions.update", this.create_competition.id),
