    ...
    <AdminLayout>
        ...
        <div class="py-12">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                ...
                <p></p>
                <a-table :dataSource="competition.programs" :columns="columns" >
                    <template #bodyCell="{ column, record}">
                        <template v-if="column.dataIndex==='operation'">
                            <a-button :href="route('manage.competition.programs.show',[record.competition_id,record.id])">View</a-button>
                        </template>
                        <template v-else>
